# CERTIBIOCIDE FOR [DOLIBARR ERP CRM](https://www.dolibarr.org)
...
Clone the repository in ```$dolibarr_main_document_root_alt/certibiocide```

```sh
cd ....../custom
git clone git@github.com:gitlogin/certibiocide.git certibiocide
```
